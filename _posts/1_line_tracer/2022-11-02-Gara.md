...
<div style="float: left; max-width: 40%;">
  <p style="text-align: center;">VREF : 0V</p>
   <img src="../../images/SLA7052M_0V.PNG" style="max-width: 500px; width: 97.5%; margin: 0 0 2.5% 2.5%"/>
  <p style="text-align: center;">VREF : 3.3V</p>
   <img src="../../images/SLA7052M_3.3V.PNG" style="max-width: 500px; width: 97.5%; margin: 0 0 0 2.5%;"/>
</div>
